...
#ifndef SRC_NRF24L01P_H_
#define SRC_NRF24L01P_H_
...
#define NRF24L01_CE (((GPIO_S*)(&(GPIOG->ODR)))->BIT8)//PG8
#define NRF24L01_CSN (((GPIO_S*)(&(GPIOG->ODR)))->BIT7)//PG7
#define NRF24L01_IRQ (((GPIO_S*)(&(GPIOG->IDR)))->BIT6)//PG6
...
void NRF24L01_RX_Mode(uint8_t *);					//配置为接收模式
void NRF24L01_TX_Mode(uint8_t *);					//配置为发送模式
